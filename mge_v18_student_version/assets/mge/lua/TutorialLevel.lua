...
--------------------------------------------------------------------------------------
StartingMoney = 50;
--Lane One only one wave
LaneOneNormieFromWave = 0; --after wave *number* normies will spawn
LaneOneSanicFromWave = 5;
LaneOneChadFromWave = 3;
LaneOneBaseSize = 20;
LaneOneSizeGrowthFrequency = 2;
LaneOneEnemyScalingPercentage = 15;
...
--Max amount of waves this level: 10