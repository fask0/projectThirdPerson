...
void TowerDefenseScene::inintialize2Dobjects()
{
	...
	//healthBarTexture0->loadFromFile(config::MGE_SPRITES_PATH + "coin.png");
	//healthBarTexture1->loadFromFile(config::MGE_SPRITES_PATH + "coin.png");
	//healthBarTexture2->loadFromFile(config::MGE_SPRITES_PATH + "coin.png");
	//healthBarTexture3->loadFromFile(config::MGE_SPRITES_PATH + "coin.png");
	//healthBarTexture4->loadFromFile(config::MGE_SPRITES_PATH + "coin.png");
	//healthBarTexture5->loadFromFile(config::MGE_SPRITES_PATH + "coin.png");
	//healthBarTexture6->loadFromFile(config::MGE_SPRITES_PATH + "coin.png");
	//healthBarTexture7->loadFromFile(config::MGE_SPRITES_PATH + "coin.png");
	//healthBarTexture8->loadFromFile(config::MGE_SPRITES_PATH + "coin.png");
	//healthBarTexture9->loadFromFile(config::MGE_SPRITES_PATH + "coin.png");
